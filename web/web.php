...
<html>
  <head>
    ...
    <link rel="icon" sizes="76x76" href="assets/img/favicon.png"/>
    <link rel="stylesheet" href="assets/fa/css/all.min.css" />
    <link rel="stylesheet" href="styles.css" />
    <title>PT RANGKAI UTAMA BERJAYA</title>
  ...
  <body class="text-gray-800 antialiased">
          ...
          <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
            <li class="flex items-center">
              <a
                ...
                href="../"
                ><span class="inline-block ml-2">Klien</span></a
              >
            </li>
            <li class="flex items-center">
              <a
                class="lg:text-white lg:hover:text-gray-300 text-gray-800 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                href="#product"
                ><span class=" inline-block ml-2">Produk</span></a
              >
            </li>
            <li class="flex items-center">
              <a
                class="lg:text-white lg:hover:text-gray-300 text-gray-800 px-3 py-4 lg:py-2 flex items-center text-xs uppercase font-bold"
                href="#service"
                ><span class=" inline-block ml-2">Layanan</span></a
              >
            </li>
            <li class="flex items-center">
              <a
    ...
    <main>
            ...
            <div class="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
              <div class="pr-12">
                ...
                <p class="mt-4 text-lg text-gray-300">
                  Kami adalah perusahaan yang bergerak di bidang Konsultan Teknologi Informasi berbasis di Medan Sumatera Utara terdiri dari tenaga ahli-tenaga ahli IT yang berusaha memberikan solusi bagi permasalahan proses bisnis pemerintah dan perusahaan.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">BERPENGALAMAN</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">PEKERJA PROFESIONAL</h6>
                  <p class="mt-2 mb-4 text-gray-600">
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-xl font-semibold">LAYANAN PELANGGAN TERBAIK</h6>
                  <p class="mt-2 mb-4 text-gray-600">
                    Selalu Diberikan
                  </p>
                </div>
          ...
          <div class="flex flex-wrap items-center mt-32">
            <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
              ...
              >
                Menjadi sentra solusi Teknologi Informasi di Sumatera dengan hadir lebih dekat dan memberikan nilai tambah dan kepuasan kepada mitra.
              </p>
              ...
              >
                ...
                <blockquote class="relative p-8 mb-4">
                  ...
                  <p class="text-md font-light mt-2 text-white">
                    Perusahaan konsultan dan pengembang teknologi informasi yang didirikan pada tahun 2017.
                    Berlokasi di Medan dengan didukung oleh tenaga ahli yang berpengalaman di sejumlah pengembangan sistem, berkompeten, inovatif dan professional.
                  </p>
                </blockquote>
              </div>
            </div>
          ...
          <div class="items-center flex flex-wrap">
            <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
              <img
                ...
                src="assets/img/protfolio_bg.jpg"
              />
            </div>
            <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                <div
                  class="text-white-600 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white-300"
                >
                  <i class="fas fa-rocket text-xl"></i>
                </div>
                <h3 class="text-3xl font-semibold">Misi</h3>
                <p class="mt-4 text-lg leading-relaxed text-gray-600">
                  ➣ Mengembangkan solusi terbaik dengan penerapan teknologi informasi & komunikasi yang tepat guna      & efektif <br><br>
                  ➣ Menjalin hubungan kerjasama yang baik dan berjangka panjang kepada pelanggan dan mitra kerja      dengan membentuk sinergi demi mencapai keberhasilan bersama. <br><br>
                  ➣ Memberikan nilai tambah bagi pelanggan, karyawan dan stakeholder.
                </p>
                <ul class="list-none mt-6">
                  <li class="py-2">
                    <div class="flex items-center">
      ...
      <section id="service" class="pb-20 relative block bg-gray-100">
        <div
          class="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20"
          style="height: 80px; transform: translateZ(0px);"
        >
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="lg:text-center">
      <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl mb-5">
        APA YANG KAMI TAWARKAN?
      </p>
      <h3 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">LAYANAN TERBAIK UNTUK SOLUSI BISNIS MITRA</h3>
    </div>
      ...
      <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
        <div class="flex">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Konsultasi dan pembangunan aplikasi bisnis merupakan keahlian kami. Dengan dukungan konsultan-konsultan TI dan Software Engineer yang handal lulusan Perguruan-Perguruan Tinggi terkemuka.
            </dd>
          </div>
        </div>
        ...
        <div class="flex">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Networking memudahkan komunikasi beberapa PC baik intranet maupun internet. Layanan yang diberikan oleh kami adalah solusi infrastruktur (perancangan, implementasi, dan maintenance) jaringan LAN, WAN, dan MAN.
            </dd>
          </div>
        </div>
        ...
        <div class="flex pt-8">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Dengan perkembangan zaman, kami siap dan selalu berusaha untuk dapat menjadi agen perubahan. Aplikasi yang memanfaatkan teknologi mobile telah menjadi salah satu inti bisnis kami.
            </dd>
          </div>
        </div>
        ...
        <div class="flex pt-8">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Pemetaan lahan, jaringan jalan, tata ruang dan pengelolaan data berbasis peta digital sudah menjadi kebutuhan penting bagi berbagai pihak, baik kalangan swasta maupun pemerintah.
            </dd>
          </div>
        </div>
        ...
        <div class="flex pt-8">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Pengembangan Perangkat Lunak berbasis Web, Desktop dan Mobile App untuk kebutuhan khusus dapat kami lakukan hingga memenuhi keinginan bisnis masa kini dan yang akan datang dari para mitra.
            </dd>
          </div>
        </div>
        ...
        <div class="flex pt-8">
          ...
          <div class="ml-4">
            ...
            <dd class="mt-2 text-base text-gray-500">
              Dengan berbekal pengalaman di sistem pemerintahan, Rangkai Utama telah mampu memetakan road map perencanaan, pengelolaan, pengontrolan, dan evaluasi implementasi TI di bidang pemerintah.
            </dd>
          </div>
        </div>
      </dl>
       ...
       <section id="product" class="relative py-20 bg-white-100">
        <div
          class="bottom-auto top-0 left-0 right-0 w-full absolute pointer-events-none overflow-hidden -mt-20"
          style="height: 80px; transform: translateZ(0px);"
        >
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <ul class="mt-5 list-disc font-bold">
              <li>SIM Rumah Sakit ( MedIS )</li>
              <li>SIM Kepegawaian ( HRD )</li>
              <li>Road Feasibility Monitoring System</li>
              <li>SIM Pelayanan IMB berbasis webGIS</li>
              <li>Sistem Pelayanan Reklame Mandiri</li>
              <li>Terpadu– Android WEBGIS</li>
              <li>Sistem Informasi Sekolah</li>
              <li>Aplikasi Akademik Perguruan Tinggi</li>
            </ul>
          </div>
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <ul class="list-disc font-bold">
                <li>Aplikasi SIMWASDA</li>
                <li>Aplikasi PBB Dispenda</li>
                <li>Aplikasi Restribusi dan Pajak Daerah</li>
                <li>Aplikasi eDiklat Penilaian Kinerja dan Pengembangan Karir</li>
                <li>Aplikasi finger print absensi</li>
                <li>Aplikasi Radio Streaming</li>
                <li>Aplikasi Manajemen Perhotelan</li>
                <li>Aplikasi Eprocurement</li>
                <li>Aplikasi SIM Aset</li>
                <li>Aplikasi Efiling</li>
                <li>Aplikasi Sistem Persediaan</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <section class="border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          ...
          <div class="flex-1 mx-auto rounded-t rounded-b-none overflow-hidden">
            <img src="assets/img/client_logo/client_logo-2.png" class="inline-flex m-8">
            <img src="assets/img/client_logo/client_logo-1.png" class="inline-flex m-8">
          </div>
      ...
      <section class="mt-10">
           <iframe style="width: 100%;"src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3982.05797575613!2d98.64216131426276!3d3.5741435513908466!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30312fcec5d8c493%3A0xa967cf6bfe165f2e!2sGg.+Karyawati%2C+Tj.+Rejo%2C+Medan+Sunggal%2C+Kota+Medan%2C+Sumatera+Utara+20154!5e0!3m2!1sid!2sid!4v1536548138945" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
      </section>
        ...
        <div class="container mx-auto px-4 lg:pt-24 lg:pb-64">
          <div class="flex flex-wrap mt-12 justify-center">
            <div class="w-full lg:w-3/12 px-4 text-center">
              ...
              >
                <i class="fas fa-sign text-xl"></i>
              </div>
              <h6 class="text-xl mt-5 font-semibold text-white">
                Alamat
              </h6>
              <p class="mt-2 mb-4 text-gray-500">
                Jl. Karyawati NO. 15, Tanjung Rejo, Medan, Indonesia
              </p>
            </div>
            <div class="w-full lg:w-3/12 px-4 text-center">
              <div
            ...
            <div class="w-full lg:w-6/12 px-4">
              ...
              >
                <div class="flex-auto p-5 lg:p-10">
                  <h4 class="text-2xl font-semibold">Kirim Pesan ke Kami</h4>
    ...
    <div class="absolute right-0 bottom-0">
      <div id="popup" class="fixed shadow-lg" style="right: 45px;bottom: 120px;width: 350px;cursor: pointer">
        <div class="bg-green-600 w-full p-3 text-white font-bold rounded-t-lg">
          <img src="assets/img/favicon.png" class="inline-block pb-4" style="width: 55px;">
          <span class="inline-block py-auto">
            PT RANGKAI UTAMA BERJAYA
            <br>
            <span class="block text-sm text-gray-300">Admin</span>
          </span>
        </div>
        <div class="w-full relative">
          <img src="assets/img/wawall.jpg" class="w-full" style="height: 120px">
          <div class="absolute p-2 rounded-lg pb-5" style="top: 20px;left: 10px;background-color: white;">
            <span class="block text-gray-600">PT RANGKAI UTAMA BERJAYA</span>
            Halo, ada yang bisa kami bantu?
            <span class="absolute text-base text-gray-500 block" style="bottom: 1px;right: 10px;font-size: 12px" id="time"></span>
          </div>
        </div>
      ...
      <img id="wa" src="assets/img/wa.svg" class="fixed" style="right: 45px;bottom: 45px;width: 65px;cursor: pointer">
    </div>
