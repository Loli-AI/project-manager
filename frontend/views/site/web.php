          ...
          <div class="items-center flex flex-wrap">
            <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
              <img
                ...
                src="<?= $mainUrl;   ?>/webassets/img/protfolio_bg.jpg"
              />
            </div>
    ...
    <div class="absolute right-0 bottom-0">
      ...
      <div id="popup" class="fixed shadow-lg" style="right: 45px;bottom: 120px;width: 300px;cursor: pointer">
        ...
        <div class="w-full relative">
          <img src="<?= $mainUrl;  ?>/webassets/img/wawall.jpg" class="w-full" style="height: 160px">
      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-wrap">
          <div class="w-full lg:w-6/12 px-4">
            <img
                  alt="..."
                  src="<?= $mainUrl;   ?>/webassets/img/logo.png"
                  class=""
                  style="width: 60%;"
                />
          </div>
