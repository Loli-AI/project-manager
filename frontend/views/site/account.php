...
<div class="container my-5">
	...
	<hr>
	<button data-toggle="modal" data-target="#username" class="btn btn-light my-3 d-block"><i class="fas fa-user-edit"></i>&nbsp;&nbsp;Ubah Nama</button>
	<button data-toggle="modal" data-target="#password" class="btn btn-light my-3 d-block"><i class="fas fa-key"></i>&nbsp;&nbsp;Ubah Sandi</button>
